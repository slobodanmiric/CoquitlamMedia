...
<head>
    ...
    <title>Sites optimisation</title>
  ...
  fjs.parentNode.insertBefore(js, fjs);
   ...
   <div class="jumbotron seoJumbo">
	<div class="container">
            ...
            <h2 class="wow zoomIn">Sites optimisation</h2>
    ...
    <section id="seoPage">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10">
                        ...
                        <h4>Search engine optimisation is one of the most important factors of <b>successful website</b>. Achieving good results in the search engines is a challenging task, and the process requires time as well. Therefore, it is necessary to understand that <b>quality content</b> is the number one factor. Frequent content updates and activities around the <b>site freshness are the imperative</b>.<br><br>
                         A complete package of services - web site design - comes with the basic SEO. That means that we can do a <b>successful keyword</b> presentation and help you with your <b>On-page</b> website content optimization, as well as <b>Google Analytics and Google Adwords</b>.<br><br>
                         Apart from the standard SEO optimization, the important thing is for a site to be optimized for browsers such as <b>Google Chrome, Safari, Mozilla Firefox, Opera or Internet Explorer</b>. All projects are thoroughly tested before and after putting into function. <br> We also do thorough tests on many different kinds of telephones and tablets, in order to avoid unpredictable views on some screen sizes. For same reasons tests are also done on different monitors.</h4>
     ...
     <section class="yellowBottom">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h3 class="wow flash">Do you have a vision for the project?</h3>
                    <p>Contact us and we will help you develop the project?  <br> Together we will come up with something great!</p>
                </div>
                <div class="col-md-4">
                     <p class="text-center" style="margin-top: 20px;"><a class="buttonCall" href="contact.php">BRING US AN IDEA</a></p>
                </div>
            </div>
        </div>
    </section>
