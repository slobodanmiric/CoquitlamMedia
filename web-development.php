...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
   ...
   <div class="jumbotron developmentJumbo">
	<div class="container">
        ...
        <h2 class="wow zoomIn">Web design & development</h2>

	</div>
   </div>
   
   
    <section id="webDesignPage">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10">
                        ...
                        <h4>We design <b>unique</b> sites and web applications that are not only compatible with desktop devices, but also responsive. In a word, they are <b>adapted to tablets and mobile phones</b> which is, apart from its practical aspects, an important feature with search engines. <br><br> Our team approaches every project from the beginning, <b>creating new things</b>, rather than just working on finished templates. <b>We do not recycle project materials.</b> <br><br>
                        We use integrated HTML 5 technology: <b>HTML 5</b>, <b>CSS3</b> and <b>JavaScript</b>. As the server side we use <b>PHP</b> and <b>Node JS</b>. As for the framework, the team applies two of the most used - <b>Twitter Bootstrap</b> and <b>Angular JS</b> and <b>jQuery</b>, the most famous JavaScript library.</h4>
